...
The inclusive fee is `quantity × (0.005 × current market reference + class rate × location coefficient)`. The current class rates are £0.025 light solid, £0.08 solid-heavy, £0.60 ultra-heavy, £0.08 safe liquid, £0.15 hazardous liquid and £0.20 gas. Buy/sale goods prices use the ordinary market APIs. The Money panel has one **Middleman fee (transport and storage)** component within its transport total; it is not an additional charge on top of that total. The measured table below is the original phase-1 trace under the earlier £0.05/£0.50 Pepper Valley schedule; the live contract and current benchmark are in the phase-0 fixture and tariff report.
