...
- **Transport costs:** bringing the inputs in and taking the output to market, on the same kind of key. It opens to show each side's cost by how it goes: Inputs · Road, Inputs · Port, Outputs · Rail, and so on, or the logistics intermediary.
