...
print("=== R7 SAWTOOTH ambient ===")
amb = [run_r7(s, "saw") for s in seeds]
...
spec = [run_r7(s, "saw", player="steel") for s in seeds]
sp = msr(spec, STEEL)
...
for label, mode in [("sawtooth", "saw"), ("R6b steady growth", "r6b")]:
