...
BAND_EDGES = [(30, 40.0), (10, 30.0), (4, 20.0), (1, 10.0)]
...
print("=== R7I: R7G + speed 2.5%/turn + static thresholds 1/4/10/30 x initial production ===")
...
json.dump({"amb": {"steel": [round(x,2) for x in st],
          ...
          open(f"{ROOT}/r7i.json", "w"))
print("wrote r7i.json")
