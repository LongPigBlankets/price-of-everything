...
def run(seed, player=False, BETA=0.5, ladder='standard', lag=None, entrant='standard',
        personas='balanced', demand='cyclical', apex_from=100):
...
print("=== APEX COMPETITION timing ===")
for lbl, af in [("off (player only)", -1), ("era 3 (t200+)", 200), ("era 2 (t100+)", 100)]:
    out["apex_" + str(af)] = profile(f"  {lbl}", apex_from=af)
