...
BETA, C_THR, SPEED, EMA_N = 0.75, 0.6, 1.5, 5
BAND_EDGES = [(5, 50.0), (2.5, 35.0), (1.5, 25.0), (1, 15.0)]
...
print("=== R7H: R7G + deep ladder (edges 1/1.5/2.5/5, targets 15/25/35/50) ===")
...
json.dump({"amb": {"steel": [round(x,2) for x in st],
          ...
          open(f"{ROOT}/r7h.json", "w"))
print("wrote r7h.json")
