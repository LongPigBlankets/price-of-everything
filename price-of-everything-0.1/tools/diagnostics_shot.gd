...
func _ready() -> void:
	...
	var pid: String = BuildingState.add_building("b_003", "r_004", "tile_9_9", "player_1", "diagshot_plant")
	...
	game._open_building_detail(BuildingState.buildings[pid])
	await _settle(16)
	...
	var fid: String = BuildingState.add_building("b_007", "r_009", "tile_8_8", "player_1", "diagshot_mill")
	...
	game._open_building_detail(BuildingState.buildings[fid])
	await _settle(16)
