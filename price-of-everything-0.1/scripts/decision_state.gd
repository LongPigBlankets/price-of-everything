...
const DECISION_DEFINITIONS := {
	...
	"family_friend": {
		...
		"choices": [
			{"id": "cfo", "label": "Give him the CFO's chair",
				...
				"advocate_seat": "cfo",
				"stance": "I can arrange a loan on favourable terms."},
	...
	"founder_departs": {
		...
		"headline": "Andrew Keeler has completed his thirty turns on the board and is retiring.",
		"body": "His seat is now vacant and his advisor benefits have ended. You can appoint a replacement.",
	...
	"planning_pushback": {
		...
		"body": "Residents have raised objections to {target_name}. Hold consultations or pay to keep construction on schedule.",
		...
		"choices": [
			{"id": "consult", "label": "Hold consultations",
				...
				"advocate_seat": "cfo",
				"stance": "Consultations avoid a cash payment, but delay construction."},
			{"id": "accelerate", "label": "Pay for acceleration",
				"effects": [{"kind": "cash", "amount": -50.0}],
				"advocate_seat": "coo",
				"stance": "Paying now keeps construction on schedule."},
			{"id": "fast_track", "label": "Fast-track the permits",
				...
				"stance": "I can arrange faster permits at a lower cost."},
		],
	},
	"union_demands": {
		"title": "Union Demands",
		"body": "Workers in your {target_name} operations are requesting higher pay. Refusing will temporarily reduce output.",
		...
		"choices": [
			{"id": "pay_rise", "label": "Concede the pay claim",
				...
				"advocate_seat": "coo",
				"stance": "Accept the pay rise to maintain output."},
			{"id": "hold_line", "label": "Hold the line on pay",
				...
				"advocate_seat": "cfo",
				"stance": "Refusing avoids higher labour costs, but output will fall temporarily."},
			{"id": "mediate", "label": "Bring in a mediator",
				...
				"stance": "Mediation can secure a smaller pay increase."},
		],
	},
	"worker_innovation": {
		"title": "Production Improvement",
		"body": "A worker at {target_name} has proposed a process improvement. You can use it to increase output, license it for cash, or develop it through research.",
		...
		"choices": [
			{"id": "adopt", "label": "Adopt it on the line",
				...
				"stance": "Adopting the process will increase output."},
			{"id": "license", "label": "License it out",
				"effects": [{"kind": "cash", "formula": "pct_of_building_revenue", "pct": 50.0}],
				"advocate_seat": "cfo",
				"stance": "Licensing provides cash immediately."},
			{"id": "research", "label": "Fold it into the research programme",
				...
				"stance": "Research can turn this idea into a permanent improvement."},
		],
	},
	"substation_failure": {
		"title": "Substation Failure",
		"body": "The transformer supplying {target_name} has failed. Repair it now, accept two turns of reduced output, or use spare parts at a higher maintenance cost.",
		...
		"choices": [
			...
			{"id": "brownout", "label": "Accept reduced output",
				"effects": [{"kind": "modifier", "domain": "recipe_output", "pct": -20.0,
					"duration_turns": 2, "label": "Brownout"}],
				"advocate_seat": "cfo",
				"stance": "We can avoid the repair bill by accepting two turns of lower output."},
			{"id": "cannibalise", "label": "Use spare parts",
				"requires_seat": "coo",
				"effects": [{"kind": "modifier", "domain": "maintenance", "pct": 15.0,
					"duration_turns": 6, "label": "Cannibalised spares"}],
				"advocate_seat": "coo",
				"stance": "Spare parts will restore output, but maintenance costs will rise temporarily."},
		],
	},
	"brokers_offer": {
		"title": "The Broker's Offer",
		"body": "A broker offers to increase the sale price of your {target_name} in exchange for an upfront fee.",
		...
		"choices": [
			...
			{"id": "decline", "label": "Decline the offer",
				"effects": [],
				"advocate_seat": "cfo",
				"stance": "Declining avoids the fee and leaves sale prices unchanged."},
			{"id": "renegotiate", "label": "Renegotiate the terms",
				...
				"stance": "I can negotiate a smaller price increase without the upfront fee."},
		],
	},
	"environmental_inspection": {
		"title": "Environmental Inspection",
		"body": "Inspectors have found pollution from {target_name}. Choose how to address the findings.",
		...
		"choices": [
			...
			{"id": "bury_it", "label": "Make it go away",
				...
				"effects": [{"kind": "modifier", "domain": "recipe_output", "pct": -10.0,
					...
					{"kind": "agenda_tag", "tag": "backroom_deal"}],
				"advocate_seat": "government_affairs",
				"stance": "I can challenge the findings, but the investigation will reduce output for three turns."},
			{"id": "clean_audit", "label": "Commission a public clean audit",
				...
				"stance": "A public audit will prevent further environmental events at this building."},
		],
	},
	"headhunters": {
		"title": "Competition for Workers",
		"body": "A competitor is offering higher pay to your {target_name} workers. Keeping them will cost more; replacing them will temporarily reduce output.",
		"scope": "building_type", "category": "labour", "priority": PRIORITY_AMBIENT,
		"target_selector": "highest_labour_building_type",
		...
		"choices": [
			{"id": "match_pay", "label": "Match their offers",
				...
				"advocate_seat": "coo",
				"stance": "Matching their offers keeps output steady at a higher labour cost."},
			{"id": "let_go", "label": "Hire replacements",
				"effects": [{"kind": "modifier", "domain": "recipe_output", "pct": -15.0,
					"duration_turns": 4, "label": "Retraining new crews"}],
				"advocate_seat": "cfo",
				"stance": "Replacement workers avoid a pay rise, but need time to reach full output."},
			{"id": "retention", "label": "Stand up a retention programme",
				...
				"advocate_seat": "hr_director",
				"stance": "A retention programme can keep workers with a smaller pay increase."},
		],
	},
	"land_deal": {
		"title": "The Land Deal",
		"body": "A developer wants to buy your unused land on {target_name} at a premium.",
		...
		"choices": [
			{"id": "sell", "label": "Sell at their price",
				...
				"advocate_seat": "cfo",
				"stance": "Selling raises cash from land we are not using."},
			...
			{"id": "counter", "label": "Counter at a premium",
				...
				"effects": [{"kind": "sell_land", "price_mult": 4.0},
					{"kind": "schedule_event", "in_turns": 5, "event": {
						...
						"body": "Construction has started on the land you sold. Land purchases on this tile now cost more.",
				...
				"stance": "A higher offer raises more cash, but the development will increase land prices on this tile."},
		],
	},
	...
	"carbon_tax_notice": {
		...
		"headline": "The new government will introduce a carbon levy from turn {levy_first}, reaching its first full rate on turn {levy_full}. Fossil fuel use will cost more.",
		"body": "The levy applies to fossil fuels you consume and to imported goods made with them. Switching to cleaner inputs and production methods can reduce the cost.",
		"scope": "company", "category": "story", "priority": PRIORITY_STORY,
		"target_selector": "company",
		"once": true, "cooldown_turns": 9999, "weight": 1.0, "default_choice": "understood",
		"choices": [
			{"id": "understood", "label": "Understood",
				"effects": [{"kind": "none",
					"describe": "The levy increases between turns {levy_first} and {levy_full}. Cleaner production can reduce exposure."}]},
		],
	},
	...
	"green_subsidy_notice": {
		...
		# Owner copy — shown big + bold above the body.
		"headline": "The government wants to increase green power generation. Subsidy payments begin on turn {subsidy_start}.",
		"body": "Solar, wind, hydro and biomass power qualify. Payments depend on how much green power you generate.",
		"scope": "company", "category": "story", "priority": PRIORITY_STORY,
		"target_selector": "company",
		"once": true, "cooldown_turns": 9999, "weight": 1.0, "default_choice": "understood",
		"choices": [
			{"id": "understood", "label": "Understood",
				"effects": [{"kind": "none",
					"describe": "Subsidies begin on turn {subsidy_start} for solar, wind, hydro and biomass power."}]},
		],
	},
	...
	"green_subsidy_end_notice": {
		...
		"headline": "Green power subsidy payments will decrease from turn {subsidy_wind_down} and end by turn {subsidy_end}.",
		"body": "The government is withdrawing support for green power. Budget for lower subsidy income during the phaseout.",
		"scope": "company", "category": "story", "priority": PRIORITY_STORY,
		"target_selector": "company",
		"once": true, "cooldown_turns": 9999, "weight": 1.0, "default_choice": "understood",
		"choices": [
			{"id": "understood", "label": "Understood",
				"effects": [{"kind": "none",
					"describe": "Subsidy payments decrease from turn {subsidy_wind_down} and end by turn {subsidy_end}."}]},
		],
	},
	"distressed_asset": {
		"title": "Distressed Asset Program",
		"body": "Investors offer to buy your buildings and provide a rescue loan. This raises cash but leaves you without the buildings.",
		"scope": "company", "category": "story", "priority": PRIORITY_STORY,
		"target_selector": "company",
		...
		"choices": [
			{"id": "accept", "label": "Accept the program",
				"effects": [{"kind": "distressed_program",
					"describe": "Sell all your buildings at 1.5x market value and receive a £500 loan. The loan has no interest for 10 turns, then follows standard terms."}],
				"advocate_seat": "cfo",
				"stance": "This raises cash to cover debts and continue operating."},
			{"id": "refuse", "label": "Decline the rescue",
				"effects": [{"kind": "none", "describe": "Keep your buildings. You still need to cover losses and debts to avoid bankruptcy."}]},
		],
	},
}
...
func _retire_founder() -> void:
	...
	EventScheduler.emit_event({
		...
		"severity": "info",
		"title": "Andrew Keeler stands down",
		"body": "Andrew has retired as %s. His seat is vacant and his advisor benefits have ended." % seat_name,
		"source": "advisors",
		"persistent": false,
...
func _emit_pulse_forewarn(_turn: int) -> void:
	...
	EventScheduler.emit_event({
		...
		"body": "A new decision is expected in about %d turns." % PULSE_LEAD_TURNS,
		"source": "decisions",
		"persistent": false,
...
## Keep policy dates factual under either saved ruleset. Presentation only.
func _policy_copy(text: String) -> String:
	return text.replace("{levy_first}", str(PolicyState.beat("ramp_first"))) \
		.replace("{levy_full}", str(PolicyState.beat("p1"))) \
		.replace("{subsidy_start}", str(PolicyState.beat("subsidy"))) \
		.replace("{subsidy_wind_down}", str(PolicyState.beat("subsidy_end_notice") + 1)) \
		.replace("{subsidy_end}", str(PolicyState.beat("subsidy_end")))
