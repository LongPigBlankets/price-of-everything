...
const INFRA_ADD_BUTTON_BLUE := Color(0.05, 0.31, 0.56)
const INFRA_ADD_BUTTON_HOVER_BLUE := Color(0.07, 0.39, 0.68)
const INFRA_DISABLED_BUTTON_BLUE := Color(0.05, 0.13, 0.2)
const SUMMARY_PANEL_BG := Color(0.015, 0.06, 0.105, 0.78)
const SUMMARY_PANEL_BORDER := Color(0.7, 0.85, 1.0, 0.34)
const SUMMARY_SUBTLE_TEXT := Color(0.7, 0.85, 1.0, 0.88)
const SUMMARY_GREEN := Color(0.43, 0.88, 0.52)
const SUMMARY_AMBER := Color(0.95, 0.72, 0.24)
const SUMMARY_RED := Color(0.94, 0.28, 0.24)
const SUMMARY_MUTED := Color(0.62, 0.68, 0.72)
