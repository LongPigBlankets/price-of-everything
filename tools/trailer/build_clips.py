...
def finish():
    ...
    effects={
      ...
      '02_sales':[('slot_lever.wav',.05,1.3,.45),('cash_register.wav',1.5,1.17,.6)],
      '04_buy_make_roller':[('slide_into_slot.wav',1,1.63,.4)],
      '05_construction':[('click_primary.wav',.933,.16,.6),('hammer.wav',1.133,1.27,.45),('click_primary.wav',2.8,.16,.6),('hammer.wav',3.0,1.27,.45)],
